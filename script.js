const accessKey = 'mkJQzmgYL2zHgdrXILvewx4G-anZzqDSib_U3yZ06Ro';
                    ...
                    <div class="image-card bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <a href="${result.links.download}" target="_blank"
                                class="mt-4 block px-4 py-2 bg-gray-500 text-white rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">Download</a>
                        </div>
                    </div>
                `;
        ...
        async function fetchTrendingTopics() {
            try {
                ...
                data.forEach(topic => {
                    ...
                    topicItem.innerHTML = `
                        <button class="trending-topic-btn bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">${topic.title}</button>
                    `;
    ...
    <div class="image-card bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div class="p-4">
            ...
            <p class="text-gray-600">Photo by ${result.user.name}</p>
            <a href="${result.links.download}" target="_blank"
            style="display: block; margin-top: 1rem; padding: 0.5rem 1rem; color: white; border-radius: 0.375rem; text-align: center; text-decoration: none;" class="bg-gray-500 hover:bg-gray-600">Download</a>
        </div>
    </div>
`;
